...
const SimplePage = () => {
  document.title = "Profile a | Velzon - React Admin & Dashboard Template";
  ...
  useEffect(() => {
    // get the info from session storage
                              ...
                              <Table className="table-borderless mb-0">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td className="text-muted">
                                      {userInfo?.user?.providerData[0]?.email
                                        ? userInfo?.user?.providerData[0]?.email
                                        : "Email"}
                                    </td>
                                  </tr>
                            ...
                            <div className="d-flex flex-wrap gap-2">
                              <div>
                                <Link to="#" className="avatar-xs d-block">
                                  <span className="avatar-title rounded-circle fs-16 bg-soft-dark text-dark text-light">
                                              ...
                                              <Row className="g-2">
                                                <div className="col-auto">
                                                  <div className="d-flex border border-dashed p-2 rounded position-relative">
                                                    <div className="flex-shrink-0">
                                                      <i className="ri-image-2-line fs-17 text-secondary"></i>
                                                    </div>
                                                ...
                                                <div className="col-auto">
                                                  <div className="d-flex border border-dashed p-2 rounded position-relative">
                                                    <div className="flex-shrink-0">
                                                      <i className="ri-file-zip-line fs-17 text-secondary"></i>
                                                    </div>
                                                    <div className="flex-grow-1 ms-2">
                                                      <h6>
                                                        <Link
